...
b1 = Book("Things Fall Apart")
b2 = Book("No Longer at Ease")

a1.sign_contract(b1, "2025-01-01", 5000)
a1.sign_contract(b2, "2025-03-01", 3000)

print(a1.total_royalties())  
print([book.title for book in a1.books()])  
print([c.book.title for c in Contract.contracts_by_date("2025-01-01")]) 
